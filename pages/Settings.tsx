...
const Settings: React.FC = () => {
  ...
  const handleSave = () => {
    ...
    // Dispara evento de storage para outras abas/componentes escutando
  ...
  return (
    <div className="pt-32 px-6 lg:px-20 max-w-4xl mx-auto pb-20 animate-in fade-in duration-700">
      <div className="flex items-center justify-between mb-12">
        <div className="space-y-2">
          <h1 className="text-4xl font-black text-white uppercase tracking-tighter">CONFIGURAÇÕES DO <span className="text-violet-500">SISTEMA</span></h1>
          <p className="text-slate-400 font-medium">Personalize a identidade visual da sua plataforma SaaS.</p>
        </div>
        <button 
          onClick={() => navigate('/')} 
          className="p-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-all text-slate-400 hover:text-white"
        >
          <ArrowLeft size={24} />
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
           ...
           <div className="bg-[#1a1d23] border border-white/5 rounded-3xl p-8 text-center space-y-6 shadow-2xl">
              <div className="relative group mx-auto w-32 h-32">
                ...
                <button 
                  ...
                  className="absolute inset-0 bg-black/60 rounded-2xl opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity cursor-pointer"
                >
        ...
        <div className="md:col-span-2 space-y-8">
           <div className="bg-[#1a1d23] border border-white/5 rounded-3xl p-8 shadow-2xl space-y-8">
              <div className="space-y-2">
